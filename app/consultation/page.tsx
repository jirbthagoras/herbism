  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: "assistant",
      content:
        "Halo! Saya Erbis, asisten herbal Anda. Apa keluhan kesehatan yang Anda rasakan hari ini? Saya akan mencarikan solusi obat herbal berdasarkan tanaman yang Anda miliki.",
      timestamp: new Date(),
    },
  ]);
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success && data.data?.answer) {
        ...
        const relatedPlants =
          typeof answer === "object" ? answer.relatedPlants : [];
      ...
      const errorMessage: Message = {
        ...
        role: "assistant",
        content:
          "Maaf, terjadi kesalahan saat menghubungi Erbis. Silakan coba lagi nanti.",
        timestamp: new Date(),
      };
            ...
            <div className="hidden lg:flex lg:col-span-4 flex-col gap-6">
              ...
              >
                <div
                  ...
                  style={{
                    background: `linear-gradient(to bottom, ${themeColors.primary}10, transparent)`,
                  }}
                />
                ...
                <p className="text-slate-500 leading-relaxed max-w-xs">
                  Teman pintar tanaman Anda. Ceritakan keluhan Anda, dan saya
                  akan buatkan racikan herbal spesial dari kebun Anda.
                </p>
                ...
                <div className="mt-8 flex gap-3 flex-wrap justify-center">
                  {[
                    ...
                    <button
                      key={tag}
                      onClick={() =>
                        setInput(`Saya merasa ${tag.toLowerCase()}`)
                      }
